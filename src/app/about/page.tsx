...
export default function AboutPage() {
    return (
        <main className="bg-white min-h-screen">
            ...
            {/* Hero Section */}
            <section className="pt-40 pb-20 px-5 bg-neutral-50 relative overflow-hidden">
            ...
            <section className="py-24 px-5">
                <div className="max-w-[1250px] mx-auto grid lg:grid-cols-[450px_1fr] gap-20 items-start">
                    <div className="space-y-6 sticky top-32">
                        <div className="flex items-center gap-3">
                            <div className="w-12 h-[2px] bg-brand-green"></div>
                            <span className="text-black/50 font-bold uppercase tracking-[0.2em] text-xs">Our Story</span>
                        </div>
                    ...
                    <div className="space-y-12">
                        <div className="relative h-[400px] rounded-[40px] overflow-hidden shadow-xl mb-12">
                            <Image
                        ...
                        <div className="prose prose-xl text-neutral-600 max-w-none space-y-8">
            ...
            {/* Who We Are & Expertise (Dark Section) */}
            <section className="py-24 px-5 bg-[#0a0a0a] text-white">
                <div className="max-w-[1250px] mx-auto space-y-32">
                    ...
                    <div className="grid lg:grid-cols-[1fr_500px] gap-20 items-center">
                        <div className="relative h-[450px] rounded-[40px] overflow-hidden order-last lg:order-first">
                            <Image
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-2 gap-8 pt-6">
                                <div className="space-y-2">
                                    <div className="text-4xl font-bold text-brand-green text-black">10+</div>
                                    <div className="text-sm text-neutral-500 uppercase tracking-widest font-bold">Years Experience</div>
                                </div>
                                <div className="space-y-2">
                                    <div className="text-4xl font-bold text-brand-green text-black">500+</div>
            ...
            <section className="py-24 px-5">
                <div className="max-w-[1250px] mx-auto grid md:grid-cols-2 gap-12">
                    {/* Mission */}
                    <div className="bg-neutral-50 p-12 rounded-[50px] space-y-8 border border-neutral-100 hover:shadow-2xl transition-all duration-500">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-3xl font-bold text-black italic">Mission</h3>
                            <h4 className="text-xl font-bold text-neutral-800">Our Commitment to Financial Security</h4>
                    ...
                    {/* Vision */}
                    <div className="bg-black p-12 rounded-[50px] space-y-8 border border-white/5 hover:shadow-2xl transition-all duration-500 group">
