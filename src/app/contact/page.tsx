        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="pt-40 pb-20 px-5 bg-neutral-50 border-b border-neutral-100">
                <div className="max-w-[1250px] mx-auto text-center space-y-6">
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <span className="text-black/50 font-bold uppercase tracking-[0.2em] text-xs">Contact Us</span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-bold text-black tracking-tight leading-tight max-w-4xl mx-auto">
            ...
            <section className="py-24 px-5">
                <div className="max-w-[1250px] mx-auto grid lg:grid-cols-[1fr_500px] gap-20 items-stretch">
                    ...
                    {/* Form Side */}
                    <div className="bg-white rounded-[50px] border border-neutral-100 p-8 md:p-12 shadow-sm">
                        <div className="space-y-10">
                            <div className="space-y-4">
                                <h2 className="text-3xl font-bold text-black">Send us a message</h2>
                                <p className="text-neutral-500 italic">Expected response time: within 24 hours.</p>
                            </div>

                            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        <label className="text-sm font-bold uppercase tracking-widest text-black ml-1">Full Name</label>
                                        <input
                                            type="text"
                                            placeholder="John Doe"
                                            className="w-full bg-neutral-50 border border-neutral-100 rounded-2xl px-6 py-4 focus:outline-none focus:border-brand-green transition-colors"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-sm font-bold uppercase tracking-widest text-black ml-1">Email Address</label>
                                        <input
                                            type="email"
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        <label className="text-sm font-bold uppercase tracking-widest text-black ml-1">Phone Number</label>
                                        <input
                                            type="tel"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-sm font-bold uppercase tracking-widest text-black ml-1">Subject</label>
                                        <select className="w-full bg-neutral-50 border border-neutral-100 rounded-2xl px-6 py-4 focus:outline-none focus:border-brand-green transition-colors appearance-none">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold uppercase tracking-widest text-black ml-1">How can we help?</label>
                                    <textarea
                                        placeholder="Tell us about your requirements..."
                                        rows={6}
                                        className="w-full bg-neutral-50 border border-neutral-100 rounded-2xl px-6 py-4 focus:outline-none focus:border-brand-green transition-colors resize-none"
                                    />
                                </div>

                                <button className="bg-black text-white px-12 py-5 rounded-2xl font-bold text-lg hover:bg-brand-green hover:text-black transition-all duration-300 flex items-center gap-3">
                    ...
                    <div className="space-y-8">
                        {/* Info Cards */}
                        <div className="bg-[#0a0a0a] text-white p-12 rounded-[50px] space-y-12 h-full border border-white/5">
                            <div className="space-y-8">
